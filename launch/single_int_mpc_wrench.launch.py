...
def generate_launch_description():
    ...
    dt_arg = DeclareLaunchArgument("dt", default_value="0.10")
    ...
    # Offboard heartbeat (thrust_and_torque=True and direct_actuator=False)
    heartbeat = Node(
    ...
    # Inner PID: body velocities -> thrust/torque (wrenches)
    vel_pid = Node(
        package="bluerov2_mpc",
    ...
    # Outer MPC: pose tracking -> body velocity setpoints
    mpc = Node(
        package="bluerov2_mpc",
        executable="single_int_mpc_node",
        name="single_int_mpc",
        output="screen",
        parameters=[{
