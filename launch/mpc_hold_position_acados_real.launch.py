...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            ...
            description='Real robot type: "standard" or "heavy_tube"',
        ),
        ...
        Node(
            package="bluerov2_control",
            executable="mpc_hold_position_acados_real",
            name="mpc_hold_position_acados_real",
            output="screen",
            parameters=[{
                # Topics
                ...
                # Model selector
                # options: "double_integrator" or "fossen"
                "model_type": "fossen",
                "robot_type": LaunchConfiguration("robot_type"),

                # Model (only for double_integrator / rigid_body)
                "mass": 13.0,
                "Ix": 0.25,
                "Iy": 0.221,
                "Iz": 0.356,
                ...
                # Physical force bounds (Newtons/Nm)
                "Fx_max_N": 88.0,
                "Fy_max_N": 88.0,
                "Fz_max_N": 137.0,
                "Mx_max_Nm": 30.0,
                ...
                "codegen_dir": "/tmp/bluerov2_acados_codegen_real",
                "rebuild_solver": True,
            }],
        ),
    ])